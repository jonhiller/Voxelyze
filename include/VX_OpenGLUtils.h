...
#ifndef VX_OPENGLUTILS_H
#define VX_OPENGLUTILS_H
...
class CVX_OpenGLUtils
{
public:
	CVX_OpenGLUtils(CVoxelyze* simulation); //!< Constructor, links to simulation
