...
#include "VX_OpenGLUtils.h"
//#include "Utils/GL_Utils.h"

//#include "new/VX_Voxel.h"
//#include "new/VX_Link.h"

CVX_OpenGLUtils::CVX_OpenGLUtils(CVoxelyze* simulation)
{
	pVx = simulation;
...
//		CGL_Utils::DrawCube((Vec3D<>)pVox->cornerNegative()*ScaleVox, (Vec3D<>)pVox->cornerPositive()*ScaleVox, true, true, 1.0, ThisColor);
